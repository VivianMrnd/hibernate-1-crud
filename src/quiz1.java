...
public class quiz1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		case 2: 	
			...
			try {
				Query query = session1.createSQLQuery("select * from persondetail where Id = :Id and lastname = :lastname");
				...
				if(p.getMiddlename()==null) {
					...
					Thread.sleep(2000);
					System.out.println();
					System.out.println("Persons id: " + p.getId());
		...
		case 3: 	
			...
			if(even >10) {
				...
				try {
					...
					Query query = session2.createSQLQuery("select * from personDetail where Id = :Id");
				...
				try {
					...
					Query query = session4.createSQLQuery("select * from personDetail where Id = :Id");
					query.setParameter("Id", id_);
					query.setResultTransformer(Transformers.aliasToBean(PersonDetail.class));
				...
				try {
					...
					Query query = session11.createSQLQuery("select * from personDetail where Id = :Id");
					query.setParameter("Id", id_);
					query.setResultTransformer(Transformers.aliasToBean(PersonDetail.class));
				...
				try {
					...
					Query query = session00.createSQLQuery("select * from personDetail where Id = :Id");
					query.setParameter("Id",id_);
					query.setResultTransformer(Transformers.aliasToBean(PersonDetail.class));
